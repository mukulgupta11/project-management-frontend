...
const COLORS = ["#8D51FF", "#00B8DB","#FFFF00", "#7BCE00"];
...
const UserDashboard = () => {
  ...
  const prepareChartData = data => {
    ...
    const taskDistributionData = [
      ...
      { status: "Unverified", count: taskDistribution?.Unverified || 0 },
    ...
    <DashboardLayout activeMenu={"Dashboard"}>
      <div className="card my-5">
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mt-5'>
          ...
          />
          <InfoCard
           label="Unverified Tasks"
           value={addThousandsSeparator(
           dashboardData?.charts?.taskDistribution?.Unverified || 0
          )}
           color="bg-yellow-500"
          />
